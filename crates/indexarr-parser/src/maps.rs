...
pub static RESOLUTION_PATTERNS: Lazy<Vec<(Regex, &'static str)>> = Lazy::new(|| {
    vec![
...
pub static CODEC_PATTERNS: Lazy<Vec<(Regex, &'static str)>> = Lazy::new(|| {
    vec![
...
pub static SOURCE_PATTERNS: Lazy<Vec<(Regex, &'static str)>> = Lazy::new(|| {
    vec![
...
pub static MODIFIER_PATTERNS: Lazy<Vec<(Regex, &'static str)>> = Lazy::new(|| {
    vec![
...
pub static HDR_PATTERNS: Lazy<Vec<(Regex, &'static str)>> = Lazy::new(|| {
    vec![
...
pub static AUDIO_CODEC_PATTERNS: Lazy<Vec<(Regex, &'static str)>> = Lazy::new(|| {
    vec![
        ...
        (
            pat(r"(?i)\b(?:DD[P+][. ]?5[. ]1|DDP5[. ]1|E-?AC-?3[. ]?5[. ]1)\b"),
            "DD+ 5.1",
        ),
        (pat(r"(?i)\b(?:DD[. ]?7[. ]1)\b"), "DD 7.1"),
        (
            pat(r"(?i)\b(?:DDP|DD[P+]|Dolby[. ]Digital[. ]Plus)\b"),
            "DD+",
        ),
        (pat(r"(?i)\bDTS\b"), "DTS"),
...
pub static AUDIO_CHANNEL_PATTERNS: Lazy<Vec<(Regex, &'static str)>> = Lazy::new(|| {
    vec![
        (pat(r"(?i)\b7[. ]1\b"), "7.1"),
        (pat(r"(?i)\b5[. ]1\b"), "5.1"),
...
pub static LANGUAGE_PATTERNS: Lazy<Vec<(Regex, &'static str)>> = Lazy::new(|| {
    vec![
        ...
        (
            pat(r"(?i)\b(?:Portuguese|Portugu[eê]s|POR)\b"),
            "Portuguese",
        ),
...
pub static NETWORK_PATTERNS: Lazy<Vec<(Regex, &'static str)>> = Lazy::new(|| {
    vec![
...
pub static EXTENSION_CATEGORIES: &[(&str, &[&str])] = &[
    (
        "video",
        &[
            "mkv", "avi", "mp4", "m4v", "wmv", "ts", "mov", "flv", "webm", "mpg", "mpeg", "m2ts",
            "vob", "ogv", "divx", "rmvb",
        ],
    ),
    (
        "audio",
        &[
            "mp3", "flac", "aac", "ogg", "wma", "wav", "m4a", "opus", "ape", "alac", "dsf", "dff",
        ],
    ),
    (
        "ebook",
        &["epub", "mobi", "azw3", "pdf", "djvu", "fb2", "lit"],
    ),
    ("comic", &["cbr", "cbz", "cb7"]),
    ("subtitle", &["srt", "sub", "ass", "ssa", "vtt", "idx"]),
    (
        "software",
        &["exe", "msi", "dmg", "iso", "img", "apk", "deb", "rpm"],
    ),
